...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=0.92\linewidth]{boost_k_fixed_2.png}
        \caption{}\label{boost-k-fixed_2}
	\end{subfigure}
	\;
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=0.92\linewidth]{boost_k_fixed_15.png}
		\caption{}\label{boost-k-fixed_15}
	\end{subfigure}
	\;
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=0.92\linewidth]{boost_k_fixed_50.png}
		\caption{}\label{boost-k-fixed_50}
	\end{subfigure}
    \caption{Run time as a function of the non-centrality $\lambda$ for d.o.f. $k=2$~(\ref{boost-k-fixed_2}), $k=15$~(\ref{boost-k-fixed_15}), $k=50$~(\ref{boost-k-fixed_50}). Vertical line shows the threshold at which corrected expression replaces the original initial guess.}\label{fig:boost-k-fixed}
\end{figure}
%
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.46\textwidth}
        \includegraphics[width=0.93\linewidth]{boost_scale_fixed_0_25.png}
        \caption{}\label{boost-scale-fixed_0_25}
	\end{subfigure}
	\quad
	\begin{subfigure}[t]{0.46\textwidth}
		\includegraphics[width=0.93\linewidth]{boost_scale_fixed_0_15.png}
		\caption{}\label{boost-scale-fixed_0_15}
	\end{subfigure} \\
	\begin{subfigure}[t]{0.46\textwidth}
		\includegraphics[width=0.93\linewidth]{boost_scale_fixed_0_05.png}
